...
public class OCRActivity extends Activity {
    ...
    private static final String TAG = "OCRz";
    ...
    public void transitionToSpellcheck(List results, Intent intent) {
        ...
        for( String s : ocrResults) {
            Log.d(TAG, "ocrResult contains: " + s);
        }
...
class OCRRequest extends AsyncTask<String /*params*/, String /*progress*/, String/*result*/> {
    private String url="https://ocr.space/api/Parse/Image";//"https://ocr.a9t9.com/api/Parse/Image";
    private ProgressDialog mProgressDialog;
